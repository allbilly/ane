...
commands = {
    reg.InDim: 0x10001, reg.pad0: 1, reg.ChCfg: 0x22, reg.Cin: 0x10, reg.Cout: 0x10,
    reg.OutDim: 0x10001, reg.pad1: 1, reg.ConvCfg: 0x5000a021, reg.pad2: 0x2041,
    reg.GroupConvCfg: 0x14001, reg.TileCfg: 1, reg.pad3: 0, reg.pad4: 0, reg.Cfg: 0x4211101,
    reg.TaskInfo: 0x100000, reg.DPE: 0,
    reg.L2Cfg: 0, reg.SourceCfg: 0x172, reg.SourceBase: 0,
    reg.SourceChannelStride: 0x10, reg.SourceRowStride: 0x100,
    reg.L2pad0: 0x100, reg.L2pad1: 0x100, reg.L2pad2: 0,
    reg.L2pad3: 0, reg.L2pad4: 0, reg.L2pad5: 0, reg.L2pad6: 0,
    reg.ResultCfg: 0x17a, reg.ResultBase: 0x100,
