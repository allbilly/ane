...
"""
Differences from add (sum.cmd → mul.cmd):
   0x22c: 0x00 → 0x04  (L2 ResultBase)
   0x272: 0x00 → 0x30  (NE MACCfg OpMode: ADD→MUL)
"""
CMD_BUF = bytearray(make_buf(0x8000, [
...
BTSP_BUF = bytearray(make_buf(0x4000, [
...
CMD_BUF[0x272] = 0x30; CMD_BUF[0x22c] = 0x04
BTSP_BUF[0x272] = 0x30; BTSP_BUF[0x22c] = 0x04
